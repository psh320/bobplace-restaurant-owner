...
export const UpdateThursday: FC<UpdateThursdayProps> = ({setRegisterData, registerData}) => {
  if (registerData.thursday !== null) {
    return (
      <View style={[styles.tableContainer, {backgroundColor: '#FFFFFF'}]}>
        ...
        >
          <CheckBoxRectangle
            ...
            onPress={() => {
              if (registerData.thursday !== null) {
                setRegisterData({...registerData, thursday: null});
              } else {
                setRegisterData({
                  ...registerData,
                  thursday: {
            ...
            isChecked={registerData.thursday !== null}
          />
        </View>
        <View style={{flex: 0.39, height: 30, alignItems: 'center', justifyContent: 'center'}}>
          <TouchableOpacity style={{height: 50, justifyContent: 'center'}}>
            <View>
              <Text>
                {processTime(registerData.thursday.startTime)}~
                {processTime(registerData.thursday.endTime)}
              </Text>
            </View>
          </TouchableOpacity>
        </View>
        <View style={{flex: 0.39, height: 30, alignItems: 'center', justifyContent: 'center'}}>
          <TouchableOpacity style={{height: 50, justifyContent: 'center'}}>
            <View>
              <Text>
                {processTime(registerData.thursday.breakStartTime)}~
                {processTime(registerData.thursday.breakEndTime)}
              </Text>
            </View>
          </TouchableOpacity>
        </View>
