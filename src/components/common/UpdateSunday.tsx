...
export const UpdateSunday: FC<UpdateSundayProps> = ({setRegisterData, registerData}) => {
  if (registerData.sunday !== null) {
    return (
      <View style={[styles.tableContainer, {backgroundColor: '#FFFFFF'}]}>
        ...
        >
          <CheckBoxRectangle
            ...
            onPress={() => {
              if (registerData.sunday !== null) {
                setRegisterData({...registerData, sunday: null});
              } else {
                setRegisterData({
                  ...registerData,
                  sunday: {
            ...
            isChecked={registerData.sunday !== null}
          />
        </View>
        <View style={{flex: 0.39, height: 30, alignItems: 'center', justifyContent: 'center'}}>
          <TouchableOpacity style={{height: 50, justifyContent: 'center'}}>
            <View>
              <Text>
                {processTime(registerData.sunday.startTime)}~
                {processTime(registerData.sunday.endTime)}
              </Text>
            </View>
          </TouchableOpacity>
        </View>
        <View style={{flex: 0.39, height: 30, alignItems: 'center', justifyContent: 'center'}}>
          <TouchableOpacity style={{height: 50, justifyContent: 'center'}}>
            <View>
              <Text>
                {processTime(registerData.sunday.breakStartTime)}~
                {processTime(registerData.sunday.breakEndTime)}
              </Text>
            </View>
          </TouchableOpacity>
        </View>
